...
caffe.set_mode_gpu()
# Example: python generate.py generator.prototxt snapshots_test/4000/generator.caffemodel
# model file is your model prototext
# caffe.Net(model_file, weight_file)
...
cv2.imshow('test1', flatten_img.reshape(8,8,img_size,img_size,3).swapaxes(2,1).reshape(8*img_size,8*img_size, 3))
# cv2.imwrite('test1.png', flatten_img)
cv2.waitKey()
